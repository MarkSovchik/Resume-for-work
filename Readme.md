...
____
Январь 2024 — настоящее время <br> 5 месяцев<br>
...
### **Федеральное казначейство России**<br>
 ...
 - Администрирование сети интернет и локальной сети<br>
 - Настройка рабочего места пользователей, переферийных устройств и IP телефонии<br>
 - Администрирование ВАТС в организации и области<br>
 - Техническая поддержка пользователей<br>
 - Использование Active Directory для работы с сетью организации<br>
 - Работа с ЭЦП, Крипто-Про, Континент-АП, Рутокен, Етокен<br>
 - Обслуживание ПК и IP-телефонов более 350 ед.<br>
____
